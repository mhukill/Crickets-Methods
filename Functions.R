...
## Pick's Theorem: the most important area calculation formula used in this pipeline
...
upperleft <- function(thorax_x, thorax_y, thorax_x_mean, thorax_y_mean, # upper left area, based on thorax info
